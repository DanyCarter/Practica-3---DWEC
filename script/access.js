...
function acceso() {
    ...
    if (nombreCompleto !== "" && !isNaN(diaNacimiento) && !isNaN(mesNacimiento) && !isNaN(anioNacimiento)) {
        ...
        document.write(`Buenos días, <strong>${primerNombre[0]}</strong> `);
        document.write(`<br>`);
        document.write(`<br>`);
        ...
        // Nombre sin las 3 primeras letras de este
        ...
        document.write(`Tu nombre completo en <strong>MAYÚSCULAS</strong> es <strong>${nombreEnMayusculas}</strong>`);
        document.write(`<br>`);
        document.write(`<br>`);
        ...
        if (mesNacimiento >= 1 && mesNacimiento <= 12) {
            ...
            document.write(`Naciste un feliz día de <strong>${estacion}</strong> del año <strong>${anioNacimiento}</strong>`);
        } else {
